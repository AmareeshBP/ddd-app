...
class _$NoteActorStateTearOff {
  ...
  _ActonInProgress actionInProgress() {
    return const _ActonInProgress();
  }
...
mixin _$NoteActorState {
  ...
  Result map<Result extends Object>({
    ...
    @required Result actionInProgress(_ActonInProgress value),
  ...
  Result maybeMap<Result extends Object>({
    ...
    Result actionInProgress(_ActonInProgress value),
...
abstract class _$ActonInProgressCopyWith<$Res> {
  factory _$ActonInProgressCopyWith(
          _ActonInProgress value, $Res Function(_ActonInProgress) then) =
      __$ActonInProgressCopyWithImpl<$Res>;
}

class __$ActonInProgressCopyWithImpl<$Res>
    extends _$NoteActorStateCopyWithImpl<$Res>
    implements _$ActonInProgressCopyWith<$Res> {
  __$ActonInProgressCopyWithImpl(
      _ActonInProgress _value, $Res Function(_ActonInProgress) _then)
      : super(_value, (v) => _then(v as _ActonInProgress));

  @override
  _ActonInProgress get _value => super._value as _ActonInProgress;
}

class _$_ActonInProgress implements _ActonInProgress {
  const _$_ActonInProgress();
  ...
  @override
  bool operator ==(dynamic other) {
    return identical(this, other) || (other is _ActonInProgress);
  }
...
abstract class _ActonInProgress implements NoteActorState {
  const factory _ActonInProgress() = _$_ActonInProgress;
}
